...
<keywordspec name="RPA.HTTP" type="LIBRARY" format="REST" scope="GLOBAL" generated="2025-02-09T16:49:50+00:00" specversion="6" source="./RPA/HTTP.py" lineno="71">
...
<arguments repr="alias, url, headers={}, cookies={}, client_certs=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['TRACE', 'DELETE', 'OPTIONS', 'HEAD', 'GET', 'PUT']">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="retry_method_list=['TRACE', 'DELETE', 'OPTIONS', 'HEAD', 'GET', 'PUT']">
<name>retry_method_list</name>
<default>['TRACE', 'DELETE', 'OPTIONS', 'HEAD', 'GET', 'PUT']</default>
</arg>
</arguments>
...
<arguments repr="alias, url, auth, headers={}, cookies={}, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['TRACE', 'DELETE', 'OPTIONS', 'HEAD', 'GET', 'PUT']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<arguments repr="alias, url, headers={}, cookies={}, auth=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['TRACE', 'DELETE', 'OPTIONS', 'HEAD', 'GET', 'PUT']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<usages>
<usage>Check Vulnerabilities</usage>
</usages>
</type>
...
<usages>
<usage>Download</usage>
<usage>Get Current Session Alias</usage>
<usage>Http Get</usage>
</usages>
</type>
</typedocs>
