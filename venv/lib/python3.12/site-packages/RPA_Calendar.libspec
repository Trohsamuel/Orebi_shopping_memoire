...
<keywordspec name="RPA.Calendar" type="LIBRARY" format="REST" scope="GLOBAL" generated="2025-02-09T16:49:48+00:00" specversion="6" source="./RPA/Calendar.py" lineno="24">
<version/>
...
<keywords>
<kw name="Add Custom Holidays" lineno="97">
...
<type name="DateTime" typedoc="datetime"/>
...
<kw name="Compare Times" lineno="884">
...
<kw name="Compare Times ${time1} &lt; ${time2}" lineno="842">
<arguments repr="">
</arguments>
<doc>Compares given times and returns `True` if `time2`
is more recent than `time1`.
...
<kw name="Compare Times ${time1} &gt; ${time2}" lineno="863">
<arguments repr="">
</arguments>
...
<kw name="Create Time" lineno="246">
...
<kw name="First Business Day Of The Month" lineno="693">
...
<kw name="Get Iso Calendar" lineno="914">
...
<kw name="Is the ${date} Business Day in ${country}" lineno="995">
<arguments repr="">
</arguments>
...
<kw name="Is the ${date} Holiday in ${country}" lineno="1054">
<arguments repr="">
</arguments>
...
<kw name="Is The Date Business Day" lineno="945">
<arguments repr="date: str | date | DateTime, country: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">
...
<kw name="Is The Date Holiday" lineno="1016">
<arguments repr="date: str | date | DateTime, country: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">
...
<kw name="Last Business Day Of The Month" lineno="737">
<arguments repr="date: str | date | DateTime, country: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">
...
<kw name="Reset Business Days" lineno="52">
<arguments repr="">
</arguments>
<doc>Reset business days back to default Monday-Friday schedule.</doc>
<shortdoc>Reset business days back to default Monday-Friday schedule.</shortdoc>
</kw>
<kw name="Reset Custom Holidays" lineno="92">
<arguments repr="">
</arguments>
<doc>Reset custom holiday list into empty list.</doc>
<shortdoc>Reset custom holiday list into empty list.</shortdoc>
</kw>
<kw name="Return Holidays" lineno="654">
...
<kw name="Return Next Business Day" lineno="574">
...
<kw name="Return Previous Business Day" lineno="541">
<arguments repr="date: str | date | DateTime, country: str | None = None, return_format: str = YYYY-MM-DD, locale: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">
...
<kw name="Set Business Days" lineno="134">
...
<kw name="Sort List Of Dates" lineno="790">
...
<kw name="Time Difference" lineno="163">
...
<kw name="Time Difference Between Timezones" lineno="505">
...
<kw name="Time Difference In Days" lineno="380">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">
...
<kw name="Time Difference In Hours" lineno="422">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">
...
<kw name="Time Difference In Minutes" lineno="464">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">
...
<kw name="Time Difference In Months" lineno="338">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">
...
<returntype name="DateTime" typedoc="datetime"/>
