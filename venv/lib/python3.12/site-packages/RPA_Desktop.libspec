...
<keywordspec name="RPA.Desktop" type="LIBRARY" format="REST" scope="GLOBAL" generated="2025-02-09T16:49:49+00:00" specversion="6" source="./RPA/Desktop/__init__.py" lineno="37">
<version/>
...
<name>action</name>
<type name="Action" typedoc="Action"/>
...
<kw name="Close All Applications" source="./RPA/Desktop/keywords/application.py" lineno="202">
<arguments repr="">
</arguments>
...
<kw name="Close Application" source="./RPA/Desktop/keywords/application.py" lineno="178">
...
<kw name="Define Region" source="./RPA/Desktop/keywords/screen.py" lineno="189">
...
<kw name="Find Element" source="./RPA/Desktop/keywords/finder.py" lineno="294">
<arguments repr="locator: str | Locator">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str | Locator">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Find Elements" source="./RPA/Desktop/keywords/finder.py" lineno="272">
<arguments repr="locator: str | Locator">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str | Locator">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Get Display Dimensions" source="./RPA/Desktop/keywords/screen.py" lineno="163">
<arguments repr="">
</arguments>
<returntype name="Region"/>
...
<kw name="Highlight Elements" source="./RPA/Desktop/keywords/screen.py" lineno="171">
<arguments repr="locator: str | Locator">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str | Locator">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Move Region" source="./RPA/Desktop/keywords/screen.py" lineno="212">
...
<kw name="Open Application" source="./RPA/Desktop/keywords/application.py" lineno="82">
...
<kw name="Open File" source="./RPA/Desktop/keywords/application.py" lineno="101">
...
<kw name="Read Text" source="./RPA/Desktop/keywords/text.py" lineno="26">
<arguments repr="locator: str | None = None, invert: bool = False, language: str | None = None, configuration: str | None = None">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="configuration: str | None = None">
...
<kw name="Resize Region" source="./RPA/Desktop/keywords/screen.py" lineno="236">
...
<kw name="Set Default Confidence" source="./RPA/Desktop/keywords/finder.py" lineno="371">
...
<kw name="Set Default Timeout" source="./RPA/Desktop/keywords/finder.py" lineno="363">
...
<kw name="Take Screenshot" source="./RPA/Desktop/keywords/screen.py" lineno="125">
...
<kw name="Wait For Element" source="./RPA/Desktop/keywords/finder.py" lineno="324">
...
<usage>Find Elements</usage>
<usage>Get Clipboard Value</usage>
