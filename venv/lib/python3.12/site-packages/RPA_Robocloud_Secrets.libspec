...
<keywordspec name="RPA.Robocloud.Secrets" type="LIBRARY" format="REST" scope="GLOBAL" generated="2025-02-09T16:49:51+00:00" specversion="6" source="./RPA/Robocloud/Secrets.py" lineno="14">
<version/>
...
<keywords>
<kw name="Get Secret" source="./RPA/Robocorp/Vault.py" lineno="611">
...
<returntype name="Secret" typedoc="dictionary"/>
...
<kw name="Set Secret" source="./RPA/Robocorp/Vault.py" lineno="619">
<arguments repr="secret: Secret">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="secret: Secret">
<name>secret</name>
<type name="Secret" typedoc="dictionary"/>
</arg>
</arguments>
