...
<keywordspec name="RPA.Excel.Application" type="LIBRARY" format="REST" scope="GLOBAL" generated="2025-02-09T16:49:49+00:00" specversion="6" source="./RPA/Excel/Application.py" lineno="96">
<version/>
...
<kw name="Close Document" source="./RPA/application.py" lineno="185">
...
<type name="SearchOrder" typedoc="SearchOrder"/>
...
<kw name="Open Application" source="./RPA/application.py" lineno="146">
...
<kw name="Quit Application" source="./RPA/application.py" lineno="210">
<arguments repr="save_changes: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="save_changes: bool = False">
<name>save_changes</name>
<type name="bool" typedoc="boolean"/>
...
<kw name="Set Object Property" source="./RPA/application.py" lineno="225">
